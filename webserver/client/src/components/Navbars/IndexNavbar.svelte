        ...
        {#if !sessionStorage.user_id}
          ...
          <li class="flex items-center">
            <a use:link href="/auth/login">
              <button
                class="bg-white-100 text-black active:bg-red-500 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150"
                type="button"
              >
                Login
              </button>
          ...
          <!-- Button Register -->
          <li class="flex items-center">
            <a use:link href="/auth/register">
              <button
                class="bg-sky-500 text-white active:bg-sky-500 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150"
                type="button"
              >
                Register Now!
              </button>
